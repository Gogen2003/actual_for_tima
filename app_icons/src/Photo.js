    ...
    return (
        ...
        <>
            <form  id='tg' onSubmit={handleSubmit(mySubmit)}>
                ...
                <Button onClick={() => window.ym(95201580,'reachGoal','Нажатие на кнопку "Обратная связь через telegram"')} type = 'submit' sx={{borderRadius: '5px', background: 'black', mt: '25px'}} variant="contained">ОТПРАВИТЬ </Button>
